...
export default function Home() {
  ...
  return <main className="friend-space" aria-label={backgroundLabel}>
    ...
    <button ref={inviteTriggerRef} className="circle-count" onClick={()=>setInviteOpen(v=>!v)} aria-label="Add people to your circle" aria-expanded={inviteOpen} aria-controls="quick-invite"><Users size={19}/><span>{circleFriends.length} close friends</span><Plus size={17}/></button>
